                ...
                <div className="max-container">
                    <div className="grid md:grid-cols-2 gap-12 max-w-6xl mx-auto">
                        ...
                        <div className="space-y-8">
                            <div>
                                <h2 className="text-3xl font-bold text-gray-900 mb-6">Vamos Conversar</h2>
                                <p className="text-gray-600 text-lg leading-relaxed">Tem dúvidas sobre nossa plataforma? Quer saber mais sobre como podemos ajudar na sua transição de carreira? Entre em contato conosco!</p>
                            </div>
                            ...
                            <div className="space-y-6">
                                <div className="flex items-start space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600">contato@reintegr.ai</p>
                                    </div>
                                </div>
                            ...
                            <div className="bg-linear-to-r from-indigo-50 to-purple-50 p-6 rounded-xl">
                        ...
                        <div className="bg-white rounded-xl shadow-lg p-8">
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <button type="submit" className="w-full bg-linear-to-r from-indigo-600 to-purple-600 text-white py-4 px-6 rounded-lg font-semibold hover:from-indigo-700 hover:to-purple-700 hover:scale-105 transition-all duration-300 shadow-lg">
                                    Enviar Mensagem
                                </button>
                            </form>
                        </div>
