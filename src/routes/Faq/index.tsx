                ...
                <div className="max-container">
                    <div className="max-w-4xl mx-auto">
                            ...
                            {faqs.map((faq, index) => (
                                <div key={index} className="bg-white dark:bg-gray-800 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 dark:border-gray-700 overflow-hidden">
                                    <button
                                        ...
                                        className="w-full text-left p-8 focus:outline-none focus:ring-2 focus:ring-indigo-500 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-200"
                                    >
                        ...
                        <div className="mt-16 bg-linear-to-r from-indigo-600 to-purple-600 dark:from-indigo-700 dark:to-purple-700 rounded-2xl p-8 text-center text-white">
                            ...
                            <Link to="/contato" className="inline-block bg-white dark:bg-gray-800 text-indigo-600 dark:text-indigo-400 px-8 py-4 rounded-full font-semibold hover:bg-gray-100 dark:hover:bg-gray-700 hover:scale-105 transition-all duration-300 shadow-lg">
                                Entre em Contato
                            </Link>
                        </div>
                    </div>
