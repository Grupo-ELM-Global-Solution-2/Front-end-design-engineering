            ...
            <section className="section-padding">
                <div className="max-container">
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        <Card icon="🎯" title="Personalização IA" description="Trilhas adaptadas ao seu perfil, experiência e objetivos específicos." className="p-8 bg-white rounded-lg shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300" />
                        <Card icon="🚀" title="Aceleração de Carreira" description="Reduza o tempo de aprendizado com conteúdo focado e prático." className="p-8 bg-white rounded-lg shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300" />
                        <Card icon="🏆" title="Progresso Gamificado" description="Acompanhe seu progresso com conquistas e níveis que mantêm você motivado." className="p-8 bg-white rounded-lg shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300" />
                    </div>
                </div>
            </section>
            ...
            <section className="section-padding">
                <div className="max-container">
                    <div className="text-center mb-12">
                        ...
                        <p className="text-lg text-gray-600 max-w-2xl mx-auto mb-8">Para acessar a avaliação personalizada, faça login ou cadastre-se.</p>
                        <Link to="/perfil" className="bg-blue-600 text-white px-8 py-4 rounded-lg font-semibold hover:bg-blue-700 hover:scale-105 transition-all duration-300 shadow-lg">Clique Aqui!</Link>
                    </div>
                </div>
            </section>
        </main>
