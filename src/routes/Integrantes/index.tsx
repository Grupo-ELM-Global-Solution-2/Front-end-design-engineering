                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        ...
                        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 text-center hover:shadow-xl hover:scale-105 transition-all duration-300">
                            ...
                            <div className="integrante-info">
                                <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">Enzo Okuizumi</h3>
                                <p className="text-gray-600 dark:text-gray-400 mb-1">RM: 561432</p>
                                <p className="text-gray-600 dark:text-gray-400 mb-4">Turma: 1TDSPG</p>
                        ...
                        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 text-center hover:shadow-xl hover:scale-105 transition-all duration-300">
                            ...
                            <div className="integrante-info">
                                <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">Lucas Barros Gouveia</h3>
                                <p className="text-gray-600 dark:text-gray-400 mb-1">RM: 566422</p>
                                <p className="text-gray-600 dark:text-gray-400 mb-4">Turma: 1TDSPG</p>
                                <div className="flex justify-center space-x-4">
                        ...
                        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 text-center hover:shadow-xl hover:scale-105 transition-all duration-300">
                            ...
                            <div className="integrante-info">
                                <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">Milton Marcelino</h3>
                                <p className="text-gray-600 dark:text-gray-400 mb-1">RM: 564836</p>
                                <p className="text-gray-600 dark:text-gray-400 mb-4">Turma: 1TDSPG</p>
                                <div className="flex justify-center space-x-4">
